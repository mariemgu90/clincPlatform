      ...
      <div className="bg-white rounded-3xl p-8 max-w-2xl w-full shadow-2xl">
        ...
        <div className="flex gap-3 mt-8">
         {onEdit&& <button
            ...
            className="flex-1 px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white rounded-xl font-bold transition-all flex items-center justify-center gap-2 shadow-md"
          >
