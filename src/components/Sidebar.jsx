...
export default function Sidebar({ items }) {
  ...
  const menuItems = allMenuItems[userRole] || allMenuItems.PATIENT;
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed bottom-4 right-4 z-50 w-14 h-14 bg-gradient-to-r from-emerald-500 to-teal-500 rounded-full shadow-2xl shadow-emerald-500/50 flex items-center justify-center text-white hover:scale-110 transition-transform"
      >
      ...
      >
          ...
          {menuItems.map((item) => {
            ...
            return (
              <Link
                ...
                onClick={() => setMobileOpen(false)}
                className={`
                  group flex items-center space-x-3 px-4 py-3.5 rounded-xl
        ...
        <button
          ...
          className="hidden lg:flex absolute -right-3 top-8 w-7 h-7 bg-slate-800 border-2 border-emerald-500 rounded-full items-center justify-center text-emerald-400 hover:bg-emerald-500 hover:text-white transition-all shadow-lg"
        >
          <svg
