...
export default function BookAppointmentPage() {
  ...
  const handleNext = () => {
    // Service is optional, skip validation for step 1
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white/70 backdrop-blur-xl rounded-2xl shadow-xl border border-white/20 p-8">
          <form onSubmit={handleSubmit} >
            ...
            {currentStep === 1 && (
              <div>
                <h2 className="text-2xl font-bold text-gray-800 mb-6">Select Service (Optional)</h2>
                <p className="text-gray-600 mb-4">Choose a specific service or skip to book a general consultation.</p>
                
                {/* Option to skip service selection */}
                <div
                  onClick={() => setSelectedService('')}
                  className={`p-6 rounded-xl border-2 cursor-pointer transition-all hover:shadow-lg mb-4 ${
                    selectedService === ''
                      ? 'border-purple-600 bg-purple-50'
                      : 'border-gray-200 hover:border-purple-300'
                  }`}
                >
                  <h3 className="text-lg font-bold text-gray-800 mb-2">General Consultation</h3>
                  <p className="text-sm text-gray-600">Book an appointment without a specific service</p>
                </div>
